...
<Blur coordinates={blur1Coordinates} />
      ...
      <Link to={"https://www.yepdesk.com/athena-22nd-annual-state-students-convention-of-iste-kerala-section"}><div className="my-5 mb-10 bg-yellow-300 rounded-xl text-black font-primary w-52 px-5 py-2 text-xl text-center">Get Pass</div></Link>
      </div>
    </div>
  )
}
